/*---
thehive:
  name: CRWDAlertIngestion
  mode: Enabled
  definition: crwd-alert-ingestion.js
  description: Ingests CrowdstrikeFalcon Alerts, also processes observables & TTPs.
  vendor: CrowdstrikeFalcon
  kind: function
  version: 1.0.0
---*/
