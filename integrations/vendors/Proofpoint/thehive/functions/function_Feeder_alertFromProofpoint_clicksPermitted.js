/*---
thehive:
  name: alertFeeder_ProofPoint_clicksPermitted
  mode: Enabled
  definition: function_Feeder_alertFromProofpoint_clicksPermitted
  description: Ingests ProofPoint clicksPermitted alerts in TheHive
  vendor: ProofPoint
  kind: function
  version: 1.0.0
---*/
